export function PageHeader({ eyebrow, title, description, actions }) {
  return (
    <div className="relative flex flex-col gap-4 overflow-hidden rounded-2xl border border-slate-800/80 bg-slate-900/40 p-4 sm:p-5 md:flex-row md:items-end md:justify-between">
      ...
      <div className="relative">
        ...
        <h2 className="mt-1 text-xl font-semibold text-slate-100 sm:text-2xl md:text-3xl">{title}</h2>
